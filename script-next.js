...
const questions = [
  ...
  },
  {
    ...
    text: "Does NLNB have a documented and tested recovery plan for a single point of failure in FIN?",
    systems: ["FIN"],
  ...
  },
  {
    id: "o4",
    category: "Operational",
    text: "Does NLNB have documented outage coordination and escalation procedures with third-party vendors?",
    systems: ["NorthGo", "PeoplePay", "WeHelp"],
    owner: "Vendor Management",
  },
  {
  ...
  },
  {
    id: "o6",
    category: "Operational",
    text: "Does NLNB use iReport to track system health, incidents, and audit trails in a consistent way?",
    systems: ["iReport"],
    owner: "Chief Risk Officer",
  },
  {
  ...
  },
  {
    id: "o9",
    category: "Operational",
    text: "Is there a documented process for turning BeSecure findings into remediation actions?",
    systems: ["BeSecure"],
  ...
  },
  {
    id: "t1",
    category: "Technical",
    text: "Are any critical NLNB systems still running on legacy Windows 10 or other unsupported infrastructure?",
    systems: ["FIN", "BODPS", "CMS"],
    owner: "Security Operations",
  },
  {
  ...
  },
  {
    id: "t3",
    category: "Technical",
    text: "Are customer and transaction data protected by documented security controls across CMS and PeoplePay?",
  ...
  },
  {
    id: "t9",
    category: "Technical",
    text: "Is audit evidence collection documented and strong enough to support compliance reviews before an audit?",
