...
const riskDefinitions = [
  {
    id: "R-01",
    title: "FIN Single Point of Failure",
    category: "Technical",
    owner: "IT Infrastructure",
    questionIds: ["b2", "b7", "o1", "o4", "t8"],
    businessRecommendation:
      "Adopt a board-approved continuity policy for FIN with clear resilience funding, failover ownership, and a maximum outage target under five minutes.",
    technicalRecommendation:
      "Implement active-active FIN deployment across geographically separate sites so traffic can fail over immediately if one node fails.",
  },
  {
    id: "R-02",
    title: "Staff Training and Experience Gap",
    category: "Operational",
    owner: "Human Resources",
    questionIds: ["o2", "o5", "o9"],
    businessRecommendation:
      "Create a talent retention and knowledge-transfer strategy so retiring staff do not take critical institutional knowledge with them.",
    technicalRecommendation:
      "Use documented runbooks, recorded system walkthroughs, and shadowing rotations to train incoming engineers on legacy and modern banking systems.",
  },
  {
    id: "R-03",
    title: "Windows Server End-of-Life",
    category: "Technical",
    owner: "IT Infrastructure",
    questionIds: ["t1", "t2", "t4", "t8"],
    businessRecommendation:
      "Treat unsupported infrastructure as an urgent modernization priority and keep leadership informed until the exposed environments are retired.",
    technicalRecommendation:
      "Upgrade the most exposed legacy servers first and place extra safeguards around any remaining unsupported systems during the transition.",
  },
  {
    id: "R-04",
    title: "Vendor Concentration and Lock-In",
    category: "Vendor",
    owner: "Vendor Management",
    questionIds: ["b4", "b5", "o6", "o8", "t5"],
    businessRecommendation:
      "Reduce dependence on single vendors by identifying backups and renegotiating contracts with stronger service protections and exit terms.",
    technicalRecommendation:
      "Build contingency workflows and integration options so operations can continue if NorthGo, PeoplePay, or WeHelp fail or change terms.",
  },
  {
    id: "R-05",
    ...
    category: "Business",
    owner: "Executive Leadership",
    questionIds: ["b1", "b3", "b6", "b8"],
    businessRecommendation:
      "Invest in a more modern, reliable customer experience so outages and outdated capabilities do not push customers toward digital-first competitors.",
    technicalRecommendation:
      "Prioritize the customer-facing stability and modernization work that most directly improves digital banking performance and adoption.",
  },
  {
    id: "R-06",
    title: "BODPS Financial Integrity Failure",
    category: "Operational",
    owner: "Finance Operations",
    questionIds: ["o1", "o4", "o7", "t6"],
    businessRecommendation:
      "Treat BODPS integrity as a financial reporting risk because corrupted downstream data can affect statements, reports, and trust.",
    technicalRecommendation:
      "Add automated validation checks in the BODPS pipeline and nightly reconciliation jobs against FIN inputs with immediate alerts on mismatches.",
  },
  {
    id: "R-07",
    title: "CMS Customer Data Breach",
    category: "Technical",
    owner: "Security Operations",
    questionIds: ["b1", "b6", "t1", "t3", "t5"],
    businessRecommendation:
      "Treat CMS as a customer trust asset and tightly limit who can access sensitive data based on role and need.",
    technicalRecommendation:
      "Encrypt CMS data, enforce role-based access, deploy DLP monitoring, and run recurring penetration testing on CMS access points.",
  },
  {
    id: "R-08",
    title: "FDIC / AML / KYC Non-Compliance",
    category: "Regulatory",
    owner: "Chief Risk Officer",
    questionIds: ["o4", "t5", "t6", "t7"],
    businessRecommendation:
      "Keep compliance continuously visible to leadership so gaps are addressed before they turn into fines, sanctions, or examiner issues.",
    technicalRecommendation:
      "Use iReport and BeSecure to strengthen real-time suspicious activity monitoring, evidence capture, and identity verification workflows.",
  },
  {
    id: "R-09",
    title: "Fourth-Party Visibility Gap",
    category: "Vendor",
    owner: "Vendor Management",
    questionIds: ["b4", "b5", "o6", "o8", "t5"],
    businessRecommendation:
      "Require vendors to disclose subcontractors and cloud dependencies so NLNB is not exposed to hidden supply-chain risks.",
    technicalRecommendation:
      "Adopt a vendor monitoring capability that tracks downstream partners and gives the bank earlier warning of security or availability issues.",
  },
  {
    id: "R-10",
    title: "AI Explainability Readiness Gap",
    category: "Regulatory",
    owner: "Chief Risk Officer",
    questionIds: ["b3", "b7", "t4", "t7"],
    businessRecommendation:
      "Establish an AI governance process so automated decisions are reviewed and defensible before they reach customers or regulators.",
    technicalRecommendation:
      "Adopt explainability tooling and preserve decision rationale logs for AI-supported loan, fraud, or onboarding workflows.",
  },
  {
    id: "R-11",
    title: "DORA Continuous Compliance Gap",
    category: "Regulatory",
    owner: "Chief Risk Officer",
    questionIds: ["o4", "o6", "t6", "t7"],
    businessRecommendation:
      "Move from periodic compliance checks to continuous resilience monitoring with regular executive review.",
    technicalRecommendation:
      "Feed system and vendor data into a monitoring dashboard with thresholds, alerts, and escalation paths that support ongoing compliance.",
  },
  {
    id: "R-12",
    title: "Cloud-Legacy Integration Instability",
    category: "Technical",
    owner: "Architecture Team",
    questionIds: ["b7", "t2", "t4", "t8"],
    businessRecommendation:
      "Treat modernization compatibility as a managed transition risk so vendor and cloud changes do not quietly disrupt core operations.",
    technicalRecommendation:
      "Validate vendor and cloud changes against FIN and BODPS before deployment and maintain documented compatibility checks.",
  },
  {
    id: "R-13",
    title: "NorthGo SaaS Outage",
    category: "Vendor",
    owner: "Vendor Management",
    questionIds: ["b1", "b2", "o3", "o8"],
    businessRecommendation:
      "Hold NorthGo to stronger outage communication and service obligations while maintaining a customer communication fallback plan.",
    technicalRecommendation:
      "Use contingency pages, mock outage exercises, and vendor performance visibility so online banking failures are contained and managed.",
  },
  {
    id: "R-14",
    title: "Network Infrastructure Single-Layer Vulnerability",
    category: "Technical",
    owner: "IT Infrastructure",
    questionIds: ["o1", "o4", "t1", "t8"],
    businessRecommendation:
      "Require redundant network layers so one shared device failure does not take major banking services offline at the same time.",
    technicalRecommendation:
      "Add segmented network design and backup paths so failures remain isolated and recovery is faster.",
  },
  {
    id: "R-15",
    title: "Cryptocurrency Integration Risk",
    category: "Technical",
    owner: "Architecture Team",
    questionIds: ["t1", "t4", "t7"],
    businessRecommendation:
      "Treat any crypto initiative as a controlled expansion area and avoid exposing legacy platforms to irreversible transaction risk too early.",
    technicalRecommendation:
      "Use secure third-party custody and tightly controlled API patterns so legacy systems do not directly manage sensitive crypto operations.",
  },
];
...
function calculateGeneratedRisks() {
  return riskDefinitions.map((risk) => {
    ...
    const answers = relatedQuestions.map((question) => Number(state.answers[question.id] || 3));
    const average =
      answers.length > 0
    ...
    return {
      ...
      explanation: buildImpactExplanation(
        ...
        likelihood,
        score,
        highDriverQuestions.length
          ? highDriverQuestions.slice(0, 3)
          : ["baseline risk posture"]
      ),
      businessRecommendation: risk.businessRecommendation,
      technicalRecommendation: risk.technicalRecommendation,
    };
  });
}
...
function renderHeatMap() {
  ...
  const findNearestRiskLabels = (impact, likelihood) => {
    const ranked = allRisks
      .map((risk) => ({
        label: risk.cellLabel || risk.title,
        distance:
          Math.abs(risk.impact - impact) + Math.abs(risk.likelihood - likelihood),
      }))
      .sort((a, b) => a.distance - b.distance || a.label.localeCompare(b.label));

    return [...new Set(ranked.map((item) => item.label))].slice(0, 2);
  };
  ...
  heatMap.innerHTML = Array.from({ length: 25 }, (_, index) => {
    ...
    const mappedItems = cellCounts[`${impact}-${likelihood}`];
    const items = mappedItems.length
      ? mappedItems
      : findNearestRiskLabels(impact, likelihood);
    const riskMarkup = items.length
      ? items
          .map((item) => `<span class="heat-risk-item">${item}</span>`)
          .join("")
      : `<span class="heat-risk-empty">Risk view unavailable</span>`;
    return `
      <article
        class="heat-cell"
        style="background:${getHeatColor(weight)}"
        title="${items.join(", ") || "No risks available"}"
      >
        <span class="heat-cell-label">Impact ${impact} • Likelihood ${likelihood}</span>
        <div class="heat-cell-risks">${riskMarkup}</div>
      </article>
    `;
  }).join("");
      ...
      (risk) => `
        <article class="recommendation-card">
          <div class="recommendation-meta">
            <span class="pill">${risk.riskCode || risk.title}</span>
